...
return array(
    ...
    'TblCountriesTableSeeder' => $baseDir . '/database/seeds/TblCountriesTableSeeder.php',
    'TblMatchesTableSeeder' => $baseDir . '/database/seeds/TblMatchesTableSeeder.php',
    'TblPlayersTableSeeder' => $baseDir . '/database/seeds/TblPlayersTableSeeder.php',
    'TblPointMasterTableSeeder' => $baseDir . '/database/seeds/TblPointMasterTableSeeder.php',
    'TblPointsTableSeeder' => $baseDir . '/database/seeds/TblPointsTableSeeder.php',
    'TblStatesTableSeeder' => $baseDir . '/database/seeds/TblStatesTableSeeder.php',
    'TblTeamPlayersTableSeeder' => $baseDir . '/database/seeds/TblTeamPlayersTableSeeder.php',
    'TblTeamsTableSeeder' => $baseDir . '/database/seeds/TblTeamsTableSeeder.php',
